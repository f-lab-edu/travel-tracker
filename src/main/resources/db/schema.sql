...
(
    ...
    created_at TIMESTAMP                         DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (travel_idx) REFERENCES travel (id),
...
(
    ...
    FOREIGN KEY (travel_idx) REFERENCES travel (id),
    FOREIGN KEY (currency_idx) REFERENCES currency (id)
);
...
(
    ...
    created_at       TIMESTAMP                                           DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (category_idx) REFERENCES category (id),
    FOREIGN KEY (budget_idx) REFERENCES budget (id),
    FOREIGN KEY (member_idx) REFERENCES member (id)
);
